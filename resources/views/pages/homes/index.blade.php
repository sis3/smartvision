        ...
        <div class="container">
                    ...
                    <h5 class="title has--border">
                        ...
                        <span>
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path d="M1.99984 2H19.9165M19.9165 2V19.9167M19.9165 2L1.99984 19.9167" stroke="black"
            ...
            <div class="mission-statement__content wow fade-in-bottom" data-wow-delay="600ms">
                ...
                <div class="mission-statement__box">
                    <h2 style="color: black;"><span class="odometer" data-count="50" style="color: black;">0</span>+
                    </h2>
                    <p style="color: black;">
                ...
                <div class="mission-statement__wrapper">
                    <div class="item-box">
                        <h4 style="color: black;"><span class="odometer" data-count="99" style="color: black;">0</span>%
                        </h4>
